...
class MeleeEnemy(Enemy):
    ...
    def update(self, dt, game_scene):
        ...
        player = game_scene.player
        player_center = player.get_center()
        distance = _entity_distance(self, player)
...
def _entity_distance(entity_a, entity_b):
    ...
    rect_a = entity_a.get_hitbox_rect()
    rect_b = entity_b.get_hitbox_rect()
    return _rect_distance(rect_a, rect_b)
