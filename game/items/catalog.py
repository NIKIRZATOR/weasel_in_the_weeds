        ...
        definitions[item_id] = ItemDefinition(
            ...
            attack_profiles={
                str(attack_kind): WeaponAttackProfile(
                    ...
                    shape=str(raw_profile.get("shape", "line")),
                    arc_degrees=float(raw_profile.get("arc_degrees", 60.0)),
                    ...
                    recovery=float(raw_profile.get("recovery", 0.0)),
                    knockback=float(raw_profile.get("knockback", 24.0)),
                    stagger=float(raw_profile.get("stagger", 0.08)),
