...
class InventoryScene(Scene):
    ...
    def _build_layout(self):
        ...
        self.hotbar_origin = (310, 168)
        self.inventory_origin = (310, 260)
    ...
    def _draw_hotbar_panel(self):
        label = self.small_font.render("Активные слоты", True, COLORS["UI_TEXT_DIM"])
        self.app.screen.blit(label, (self.hotbar_origin[0], self.hotbar_origin[1] - 24))
